...
const Login = () => {
  ...
  return (
    <div 
      className='min-h-[80vh] flex items-center w-full bg-cover bg-center rounded-2xl overflow-hidden'
    ...
    >
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border border-white/30 rounded-xl text-gray-800 text-sm shadow-xl bg-white/10 backdrop-blur-sm'>
        ...
        <div className='w-full mt-2 pt-3 border-t border-gray-200 text-center'>
          <a href="http://localhost:5174" target="_blank" rel="noopener noreferrer" className='text-gray-500 text-xs hover:text-primary transition-colors duration-200'>
            Login as <span className='font-semibold'>Admin / Doctor</span> →
          </a>
        </div>
      </form>
    </div>
