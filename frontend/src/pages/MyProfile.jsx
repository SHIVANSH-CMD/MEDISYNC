            ...
            <div className='mt-2'>
                ...
                {showChangePassword && (
                    <div className='mt-3 flex flex-col gap-3 max-w-sm'>
                        <div>
                            <p className='text-gray-600 font-medium mb-1'>Current Password</p>
                            <input
                        ...
                        <div>
                            <p className='text-gray-600 font-medium mb-1'>New Password</p>
                            <input
                                className='w-full border border-gray-300 rounded px-3 py-2 text-sm outline-primary'
                                type="password"
                        ...
                        <div>
                            <p className='text-gray-600 font-medium mb-1'>Confirm New Password</p>
                            <input
                                className='w-full border border-gray-300 rounded px-3 py-2 text-sm outline-primary'
                                type="password"
                        ...
                        <button
                            ...
                            className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all w-fit mt-1'
                        >
                            Update Password
                        </button>
                    </div>
